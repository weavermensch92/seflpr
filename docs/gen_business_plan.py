...
make_table(
    ["항목", "포인트", "원화 환산"],
    [
        ["포인트 충전", "60P / 10,000원", "1P ≈ 167원"],
        ["자소서 프로젝트 생성", "30P", "≈ 5,000원"],
        ["면접 연습 세션 시작", "60P", "≈ 10,000원"],
        ["면접 — 신규 질문", "2P", "≈ 334원"],
        ["면접 — 꼬리 질문", "1P", "≈ 167원"],
    ],
    col_widths=[7, 4, 5]
...
add_para("수익 = 5,000원 − 180원 = 4,820원/건 (마진율 96%)", bold=True, color=GREEN)
...
add_para("세션 수입 ≈ 15,000원 / AI 원가 940원 → 수익 14,060원 (마진율 94%)", bold=True, color=GREEN)
